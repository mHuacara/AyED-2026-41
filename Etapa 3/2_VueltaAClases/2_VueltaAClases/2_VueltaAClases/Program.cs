...
namespace _2_VueltaAClases
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.Write("Cuanto te sacaste en el examen numero " + num1 + "(nota maxima 10) ?: ");
                nota_examen[n] = int.Parse(Console.ReadLine());
                Console.Write("");
                num1++;
            }
            ...
            if (promedio_examenes >= 6 && aprobados >= cantidad_tps * 0.75)
            {
                Console.WriteLine("Si pueden aprobar");
            }
            else
            {
                Console.Write("No podran aprobar");
            }
